...
/*!***********************************************!*\
  !*** ./blocks/split-card-with-slides/view.js ***!
  \***********************************************/
...
!function (n, t) {
  ...
  function p(n, t) {
    return [n, t].reduce((n, t) => (f(t).forEach(e => {
      const o = n[e],
        i = t[e],
        c = r(o) && r(i);
      n[e] = c ? p(o, i) : i;
  ...
  function g() {
    ...
    const t = {
      add: function (e, r, o, i = {
        ...
        let c;
        if ("addEventListener" in e) e.addEventListener(r, o, i), c = () => e.removeEventListener(r, o, i);else {
          const n = e;
  ...
  function v(n, t, r, u, s, a, d, l, f, p, h, y, v, b, S, w, E, L, D) {
    ...
    function q(n) {
      ...
      r > w && (j = !0), p.useFriction(.3).useDuration(.75), l.start(), s.add(M(i)), n.preventDefault();
    }
    function U(n) {
    ...
    return {
      init: function (n) {
        ...
        const i = t;
        T.add(i, "dragstart", n => n.preventDefault(), F).add(i, "touchmove", () => {}, F).add(i, "touchend", () => {}).add(i, "touchstart", o).add(i, "mousedown", o).add(i, "touchcancel", U).add(i, "contextmenu", U).add(i, "click", W, !0);
      },
      destroy: function () {
        T.clear(), O.clear();
      },
    ...
    const {
      ...
      an = O(Z, _, G, B, J, K, un, sn, 2),
      {
        ...
        const {
          ...
          d = a(r).map(n => s(n)[u] - n[0][c]).map(o).map(t.measure),
          l = r.map(n => e[c] - n[c]).map(n => -o(n)),
          f = a(l).map(n => n[0]).map((n, t) => n + d[t]);
        return {
          snaps: l,
          snapsAligned: f
        };
      ...
      On = T(e, r, P, j),
      {
        ...
        return {
          slideRegistry: function () {
            const r = c(i),
              o = !n || "keepSnaps" === t;
            return 1 === e.length ? [i] : o ? r : r.slice(u, f).map((n, t, e) => {
              const r = !t,
                o = d(e, t);
      ...
      Hn = {
        ...
        animation: bn,
        axis: Z,
        dragHandler: v(Z, n, f, p, Dn, b(Z, p), wn, bn, An, In, Mn, xn, P, nn, N, R, q, .68, Q),
        eventStore: Tn,
        percentOfView: nn,
        index: xn,
        indexPrevious: yn,
    ...
    const e = {
      ...
      optionsAtMedia: function (e) {
        const r = e.breakpoints || {},
          o = f(r).filter(t => n.matchMedia(t).matches).map(n => r[n]).reduce((n, e) => t(n, e), {});
        return t(e, o);
      },
  ...
  function k(n, e, r) {
    ...
    function M(e, r) {
      w || (E = d(E, e), L = l(E), D = r || D, function () {
        ...
        options: n
      }) => n)]).forEach(n => s.add(n, "change", A)), L.active && (y.translate.to(y.location.get()), y.animation.init(), y.slidesInView.init(), y.slideFocus.init(V), y.eventHandler.init(V), y.resizeHandler.init(V), y.slidesHandler.init(V), y.options.loop && y.slideLooper.loop(), b.offsetParent && S.length && y.dragHandler.init(V), v = u.init(V, D)));
    }
    function A(n, t) {
      const e = O();
      F(), M(d({
...
document.addEventListener('DOMContentLoaded', () => {
  const blocks = document.querySelectorAll('.wp-block-heru-split-card-with-slides');
